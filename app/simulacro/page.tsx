    ...
    >
      ...
      <div className="w-full px-4 md:px-8 py-8">
        <div className="mb-6 container mx-auto">
          <Link
            href="/"
            className="inline-flex cursor-pointer items-center gap-2 text-sm font-bold transition-colors hover:opacity-80"
            style={{ color: "#503224" }}
          >
            <ArrowLeft size={20} />
            Volver al inicio
        ...
        <div className="text-center mb-10 container mx-auto">
          ...
          <p
            className="font-body text-base md:text-lg max-w-3xl mx-auto leading-relaxed"
            style={{ color: "#503224" }}
          >
