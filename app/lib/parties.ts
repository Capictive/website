...
const candidatosMap: Record<string, Candidatos> = {
    ...
    "Integrida Democrática": { presidente: "Wolfgang Grozo Costa", primer_vicepresidente: "Betha Azabache Miranda", segundo_vicepresidente: "Wellington Prada" },
...
export const PARTIES: Party[] = [
    ...
    { id: "integridad_democratica", name: "Integrida Democrática", description: "Partido político peruano", logo: logoMap["Integrida Democrática"], candidateImage: "/capictive.png", candidatos: candidatosMap["Integrida Democrática"] || defaultCandidatos },
